                    ...
                    <Row className="m20">
                        <Col md="6" className="tabInfo">
                            <Row className="text">
                                ...
                                <Col md="12">
                                    <span className="gold_color">Сучасна баня на пантоні</span> обладнана найсучасними банними технологіями" має світлу парну оснащенну усім необхідним приладдям. Зона відпочинку (сінна релакс кімната) площею 10 м² має велике двоспальне ліжко. У ванній кімнаті душова кабіна. Великий мебльований зал з каміном та видом на Дніпро.
                                </Col>
