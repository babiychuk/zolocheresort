                    ...
                    <Row className="m20">
                        <Col md="6" className="tabInfo">
                            <Row className="text">
                                ...
                                <Col md="12">
                                        Сучасний одноповерховий будинок на плаву з плоским дахом, площею 120 м². 
										У будинку розташована кухня-їдальня, затишна вітальня, гардеробна кімната. 
										Господарська спальня, спальня для гостей, гардеробна-кабінет і 2 ванні кімнати. 
										Велика крита тераса з чудовим краєвидом на Дніпро. Родзинкою будинку є відкрита 
										тераса на даху будинку, площею 90 м². Будинок побудований з екологічно чистих 
										матеріалів з дизайнерським ремонтом, повністю мебльований, є вся необхідна побутова техніка. 
										Опалення здійснюється за допомогою електрики, всі будинки підключені до центральній системі 
										очищення стічних вод. Всі системи оснащені аварійним джерелом живлення (дизельний генератор), 
										що виключає їх перебої в работі. До ваших послуг: басейн (дорослий і дитячий) 
										із зоною відпочинку, дитячий майданчик, дитячий ігровий центр, ресторан, фітнес-центр, 
										спа-зона, салон краси.
                                </Col>
