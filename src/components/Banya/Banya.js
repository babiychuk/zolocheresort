                ...
                <Row >
                    <Col md="12">
                        <div className="text_in_block bg_hotelRooms">
                            <p> На березі Дніпра у поєднанні з природою, сучасний острівець для відновлення зв‘язку душі і тіла. Лазня на понтоні в Riviera Zoloche Resort & SPA. Це місце де можна зустрітися з друзями та в приємній компанії відпочити з користю для здоров’я, відновити сили, зміцнити імунітет, знайти натхнення. До ваших послуг класична лазня на дровах, вимощена деревиною дикої липи, з повним комплексом самих правильних заходів,щоб зробити ваш відпочинок не лише приємним, але і максимально корисним.
                            </p>
                            <div>
                                <Col md="12">
                                    <ul>Отже, ми пропонуємо рухатись за планом найприємнішого оздоровлення:
                                        ...
                                        <li>Душ та насолоджуємося смачним чайком у чайній кімнаті, відновлюючи баланс рідини у власному тілі</li>
                                        <li>Час пропарити ноги та подихати запашними травами, що випаровуються з каміння</li>
