                ...
                <div className="row">
                    <div className="col-md-12 ">
                        <div className="text_in_block bg_housesWater">
                            <div>
                            Сучасний одноповерховий будинок на плаву з пласким дахом., площею 120 м². В будинку розташована кухня, обідня зона, вітальня, кабінет з розкладним диваном. Дві просторі спальні, дві ванні кімнати. Затишна мебльована тераса не лише з розкішним видом на Дніпро, а й розташована над водою. На даху також є тераса площею 90 м² з меблями для відпочинку
                            </div>
                        </div>          
                    </div>
                </div>
