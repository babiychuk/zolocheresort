                ...
                <Row >
                    <Col md="12">
                        <div className="text_in_block bg_hotelRooms">
                            <p className="">
                            365 STUDIO - мережа студій краси нового покоління. Це місце сили, наповнення, турботи про вашу красу і ваше здоров'я.Серед послуг представлені : манікюр, педикюр, укладання, фарбування, стрижки, мейкап, лікування волосся, догляд за бровами (корекція та фарбування), массаж.В студії використовуються максимально безпечні бренди - Luxio, Davines, NCLA, ONIQ, Zoya, American Crew. У всіх студіях 365 продається натуральна косметика з Балі - Sensatia Botanicals.
						</p>
                        </div>
                    </Col>
                </Row>
