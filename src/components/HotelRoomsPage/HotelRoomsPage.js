    ...
    constructor(props) {
        ...
        this.state = {
            ...
            rooms: [
                ...
                {
                    name: "Люкс",
                    text: "Світлий і просторий двокімнатний номер площею 53 м² з розкішним видом на Дніпро. Велика вітальня з панорамними вікнами і виходом на терасу, барною стійкою, телевізором і зручним диваном. Затишна ванна кімната з великою ванною і душовою кабіною. У спальні велике двоспальне ліжко, телевізор",
