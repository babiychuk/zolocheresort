                    ...
                    <Row>
                        <Row className="m35 tabInfo">
                            <Col md="6">
                                ...
                                <p className="titleAbout">Острівець комфорту серед чарівної природи для сімейного відпочинку та дозвілля</p>
                                <p><span className="gold_color">Riviera Zoloche Resort</span> - це частина комплексу Zoloche, розташована на березі Дніпра і орієнтована на здачу будинків та готельних номерів в оренду. Затишні будиночки наберезі Дніпра, романтичні будинки на плаву та сучасні готельні номери - подарують відчуття повного єднання з природою далеко від гамірного міста. Дизайн виконаний в сучасному стилі, будинки та номери обладнані усім необхідним: зручними меблями, посудом, побутовою технікою. Розкішний краєвид, повний релакс та максимальний затишок вам подарують комфортабельні тераси.</p>
                            </Col>
                            <Col md="6">
                                <Col md="12">
