                ...
                <div className="row">
                    <div className="col-md-12 ">
                        <div className="text_in_block bg_hotelRooms">
                            <p className="">
                                <span className="light_gold_color">Riviera Zoloche Resort & SPA</span> пропонує готельні номери з розкішним видом на Дніпро. У кожному номері є кондиціонер, швидкісний інтернет, супутникове телебачення. Для послуг гостей таця гостинності з усім необхідним для приготування чаю та кави. У ванній кімнаті є набір міні парфумерії, халати, капці і фен. Тераси обладнані зручними вуличними меблями. У міні барі напої і закуски за додаткову плату. За потребою надається праска, прасувальна дошка та додаткове спальне місце. У вартість проживання, в літній час, входить відвідування зони відпочинку з басейнами, а в зимовий час, відвідування тренажерного залу.
